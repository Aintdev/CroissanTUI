#pragma once
#define _CTUIMSG_VSTACK_WRONG_KWARG "Unknown Keyword Argument for VStack!\n\nCheck the error message below and search for:\n\t\t'T=ctui::detail::Kwarg<_tag_(YOUR_INVALID_ARG)'.\n\n"
#define _CTUIMSG_SCREEN_WRONG_KWARG "Unknown Keyword Argument for Screen!\n\nCheck the error message below and search for:\n\t\t'T=ctui::detail::Kwarg<_tag_(YOUR_INVALID_ARG)'.\n\n"
#define _CTUIMSG_LABEL_WRONG_KWARG "Unknown Keyword Argument for Label!\n\nCheck the error message below and search for:\n\t\t'T=ctui::detail::Kwarg<_tag_(YOUR_INVALID_ARG)'.\n\n"
